...
system.time(error_sim(file = "DAB053demo01.tag8.fastq", err_rate = 0.03, substitutions = 1, insertions = 0, deletions = 0))
...
demo_data_import(subset_seq = FALSE, subset_size = 10000, input_folder = "./data/error_data/", input_file = "DAB053demo01.tag16.error2.indel.s34.i33.d33_TEST3.fastq")
...
out2 <- mclapply(fishbone_input, FUN = callAllele, tbase = mt, verbose = FALSE)
